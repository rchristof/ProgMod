...
def loadTransactionsFromFile(file_path="database/transactions/_transactions.txt"):
...
def saveTransactionsToFile(file_path="database/transactions/_transactions.txt"):
